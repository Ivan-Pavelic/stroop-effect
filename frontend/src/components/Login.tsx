      ...
      <div className="w-full max-w-md px-2">
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
            <div>
              <label htmlFor="username" className="block text-gray-700 text-sm sm:text-base font-semibold mb-2 sm:mb-3 text-left">
                Korisničko ime
              </label>
              <input
                id="username"
                ...
                required
                className="w-full px-4 sm:px-5 py-3 sm:py-4 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 text-base sm:text-lg transition-all"
                placeholder="ime.prezime"
              />
            </div>

            <div>
              <label htmlFor="password" className="block text-gray-700 text-sm sm:text-base font-semibold mb-2 sm:mb-3 text-left">
                Lozinka
              </label>
              <input
                id="password"
